...
class FcmServiceImpl(
    ...
    override fun sendMessagesAsync(messages: List<FcmMessageDto>): Flow<String> = flow {
        ...
        if (failures.isNotEmpty()) {
            logger.warn("일부 FCM 메시지 전송 실패: total={}, success={}, failure={}", 
                messages.size, results.size, failures.size)
        }
